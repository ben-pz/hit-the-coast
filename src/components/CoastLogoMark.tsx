...
/**
 * The site's mark: the traced outline of the Cornwall coast path, standing in
 * for the club badge until there is a real brand mark.
 *
 ...
 * segments. Pure vector, so it stays crisp from a 24px header badge up to a
...
export function CoastLogoMark({
  ...
  return (
    ...
    >
      <rect width="100" height="100" fill="var(--color-ink-700)" />
      <polyline
