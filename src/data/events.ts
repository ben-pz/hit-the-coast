...
export const events: CoastalEvent[] = [
  {
    ...
    image: '/images/events/arc-of-attrition.svg',
    imageAlt:
      'Placeholder artwork: contour lines along an exposed stretch of Cornish cliff',
    featured: true,
  ...
  },
  {
    ...
    image: '/images/events/cousin-jack.svg',
    imageAlt:
      'Placeholder artwork: a point-to-point line across a granite headland',
    featured: true,
  ...
  },
  {
    ...
    image: '/images/events/classic-quarter.svg',
    imageAlt:
      'Placeholder artwork: a long coastline curving from a southern point to a western one',
    featured: true,
    ticketStatus: 'Entries open',
    verified: true,
  },
